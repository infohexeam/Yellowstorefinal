...
class Helper
{
    ...
    public static function countOrders($store, $dboy)
    {
        return $dboy = Trn_store_order::where('store_id', $store)
            ->where('delivery_boy_id', $dboy)->where('status_id', 9)->count();
    }
    ...
    public static function storeRating($store_id)
    {
        ...
        $countRating = Trn_ReviewsAndRating::where('store_id', $store_id)->count();
    ...
    {
        return $countRating = Trn_ReviewsAndRating::where('store_id', $store_id)->count();
    }
