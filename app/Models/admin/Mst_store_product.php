...
class Mst_store_product extends Model
{
  ...
  protected $fillable = [
    ...
    'product_type', 'service_type', 'sub_category_id', 'min_stock', 'is_removed', 'is_added_from_web','display_flag','is_timeslot_based_product','timeslot_start_time','timeslot_end_time','is_product_listed_by_product'
