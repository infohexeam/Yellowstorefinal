...
class Trn_store_order extends Model
{
   protected $primaryKey = "order_id";
    ...
    protected $fillable = [
    					    'order_id','order_number','customer_id','order_item_id'
    					    ,'product_varient_id','store_id','product_total_amount'
    					    ,'quantity','shipping_address','country_id','state_id'
    					    ,'district_id','shipping_landmark','shipping_pincode','service_order','delivery_address'
