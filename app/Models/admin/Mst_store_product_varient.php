...
class Mst_store_product_varient extends Model
{
  ...
  protected $fillable = [
    ...
    'product_varient_base_image', 'product_id', 'store_id', 'stock_count', 'attr_group_id', 'attr_value_id', 'is_removed', 'is_base_variant','variant_status','included_in_low_stock_alert'
