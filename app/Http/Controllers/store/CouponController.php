...
class CouponController extends Controller
{
  ...
  public function showReport(Request $request)
  {
    // try {
      ...
      $data=$data->groupBy('trn__recently_visited_products.product_varient_id', 'trn__recently_visited_products.created_at')->orderBy('trn__recently_visited_products.rvp_id', 'DESC')->get();
