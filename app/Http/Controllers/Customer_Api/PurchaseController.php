        ...
        $excess_store_set=false;
            ...
            { 
                ...
                if($request->store_points==1)
                {
                    ...
                    {
                        $data['status']=0;
                        $data['message']="The order amount should be greater than ₹".$storeConfigPoints->minimum_order_amount." to use wallet points";
                        return response($data);
                    ...
                    if($request->cart_type)
                    {
                        ...
                        if (isset($varProdu)) { 
                            ...
                            if ($totcountInCart == 0)
                            {
                                ...
                                $data['message'] = 'Stock unavailableeeeeeeeeeeee'.$proData->product_type;
                                $data['status'] = 3;
                                return response($data);
                            }
