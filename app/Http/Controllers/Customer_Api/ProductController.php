            ...
            if (isset($request->store_id) && Mst_store::find($request->store_id)) {
                if (isset($request->category_id) && Mst_categories::find($request->category_id)) {
                    ...
                    if ($request->customer_id == 0) {
                        ...
                        $opros  = Mst_store_product::join(
                            'mst_store_product_varients',
                            'mst_store_products.product_type',
                            'mst_store_products.service_type',
        ...
        try {
            if ($request->customer_id == 0) {
                ...
                if (isset($request->customer_id) && Trn_store_customer::find($request->customer_id)) {
                    ...
                    $recentlyVisited = Trn_RecentlyVisitedStore::select('mst_stores.store_id', 'mst_stores.store_name', 'mst_stores.profile_image')
