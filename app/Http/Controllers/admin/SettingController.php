...
// 			Image::make($category_icon)->save($location);
  ...
  public function updateCategory(Request $request,
  								 Mst_categories $category, $category_id)
    {
  ...
  public function updateBusiness(Request $request,
  								 Mst_categories $business_type, $business_type_id)
    {
...
*/
  ...
  public function updateAgency(Request $request,
  								 Mst_store_agencies $agency, $agency_id)
    {
...
//dd($agencies);
 ...
 public function listCompany(Request $request)
  ...
  public function updateCompany(Request $request,
  								 Mst_store_companies $company, $company_id)
    {
...
*/
 ...
 public function Store_settlment(Request $request, Trn_store_order $order,Trn_store_payment_settlment $payment_settlment)
 {
        ...
        $payment_settlment->save();
          ...
          return redirect()->back()->with('status','Store payment settlment placed.');
 }
 ...
 public function Delivery_boy_settlment(Request $request, Trn_store_order $order,Trn_delivery_boy_payment_settlment $delivery_boy_payment_settlment)
 {
        ...
        $delivery_boy_payment_settlment->save();
          ...
          return redirect()->back()->with('status','Delivery boy payment settlment placed.');
 }
...
/*
    ...
    Trn_store_order $order, $order_id)
    {
...
public function listRewardType(Request $request)
  ...
  public function updateRewardType(Request $request,
  	 Trn_customer_reward_transaction_type $reward_type,$transaction_type_id)
    {
...
public function RemovePointsRedeemed(Request $request,$rp_id, Trn_points_redeemed $points)
{
  ...
  public function updateCustomerReward(Request $request,
  	 Trn_customer_reward $customer_reward,$reward_id)
    {
...
public function assignSubadminAgency(Request $request, $id)
	...
	public function statusStoreSubadmin(Request $request,Mst_store $store,
