                      ...
                      <div class="col-lg-12">
                             ...
                             <div class="card-header">
                              ...
                              <div class="card-body border">
                                <form action="{{route('admin.offline_sales_reports')}}" method="GET" enctype="multipart/form-data">
                                   @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-12">
                                            <div class="form-group">
                                                <center>
                                                   ...
                                                   <a href="{{route('admin.offline_sales_reports')}}"  class="btn btn-info">Cancel</a>
                                                </center>
                                            </div>
                                          </div>
