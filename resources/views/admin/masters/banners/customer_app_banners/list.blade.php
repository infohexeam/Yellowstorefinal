                ...
                <div class="row">
                    <div class="col-12" >
                        ...
                        <div class="card-body">
                                    ...
                                    <i class="fa fa-plus"></i> Add Customer App Banner </a>
                        @if(auth()->user()->user_role_id == 0)
                         <a href=" {{ url('admin/customer-app-banner/restore-list') }}" class=" text-white btn btn-block btn-danger">
                           <i class="fa fa-recycle"></i>
                          Restore Customer App Banner
                        </a>
                        @endif
                                <br>
                                ...
                                <thead>
                                 ...
                                 <tbody>
                                    ...
                                    <td>
                                        ...
                                        <td>
                                            <form action="{{route('admin.destroy_customer_app_banner',$data->banner_id)}}" method="POST">
                                                @csrf
                                                @method('POST')
...
{{-- container end --}}
      ...
      <div class="modal fade" id="StockModal01" tabindex="-1" role="dialog"  aria-hidden="true">
               <div class="modal-dialog" role="document">
                 ...
                 <form action=" {{ route('admin.create_customr_app_banner') }} " method="POST" enctype="multipart/form-data" >
                 @csrf
