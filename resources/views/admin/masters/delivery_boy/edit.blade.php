  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
                   ...
                   <label class="form-label"> Password </label>
                            <input class="form-control" type="password" name="password" onkeyup="validatePassLength()" oninput="checkPasswordComplexity(this.value)" name="delivery_boy_password" value="{{old('password')}}" placeholder="Password" id="password" type="password"  autocomplete="current-password">
