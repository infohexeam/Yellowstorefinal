                 ...
                 <thead>
                  ...
                  <tbody>
                     ...
                     @if($store_data)
                        <tr>
                           <td>{{ ++$i }}</td>
                           <td>{{$store_data->store_name}}@if($store_data->store_code!=NULL)-{{$store_data->store_code}} @endif</td>
