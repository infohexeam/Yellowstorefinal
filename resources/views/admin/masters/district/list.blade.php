                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('admin.destroy_district',$data->district_id)}}" method="POST">
                                                @csrf
                <a href="{{url('admin/district/edit/'.$data->district_id)}}" class="btn btn-sm btn-cyan"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
               ...
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     <div class="modal-header">
                        <h5 class="modal-title" id="example-Modal3">Add New District</h5>
