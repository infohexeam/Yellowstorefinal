                     ...
                     <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <label class="form-label">Store Mobile Number</label>
                                <input type="text" maxlength="10" name="store_mobile" class="form-control"  value="{{old('store_mobile',$store->store_mobile)}}" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  placeholder="Store Mobile Number">
                            </div>
                        </div>
 ...
 @if (auth()->user()->user_role_id == 0)
                  <div class="col-md-6">
                    <div class="form-group">
                          ...
                          <input type="number"    name="store_commision_amount" step="0.1" class="form-control" placeholder="Store Commision Amount (Monthly) "  value="{{old('store_commision_amount',$store->store_commision_amount )}}">
                    </div>
                     </div>
                   ...
                   <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number"   name="store_commision_percentage"  step="0.1" class="form-control" value="{{old('store_commision_percentage',$store->store_commision_percentage)}}" placeholder="Store Commission Percentage (Per Order)" >
                        </div>
                     </div>
@endif
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           name="store_document_gstin" value="{{old('store_document_gstin',@$store->store_doc->store_document_gstin)}}" placeholder="Store GSTIN">
                        </div>
                     </div>
