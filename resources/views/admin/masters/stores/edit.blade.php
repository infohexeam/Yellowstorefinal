        ...
        @if (auth()->user()->user_role_id == 0)
                 ...
                 Collect From Store
                      ...
                      <div class="form-group">
                         ...
                         <input type="time" readonly  value="{{$store->delivery_start_time??'07:00'}}"   class="form-control"   name="delivery_start_time">
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                         ...
                         <input type="time" readonly  value="{{$store->delivery_end_time??'19:00'}}"   class="form-control  " name="delivery_end_time">
                        <span style="color:red" id="prefixErr" ></span>
                      </div>
                   </div>
                        <div class="col-md-4">
