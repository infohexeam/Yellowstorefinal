                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" required class="form-control" id="agency_pincode" name="agency_pincode" value="{{old('agency_pincode')}}" placeholder="Pincode" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')">
                        </div>
                        </div>
                          <div class="col-md-6">
                  <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="Password" onkeyup="validatePassLength()" oninput="checkPasswordComplexity(this.value)" id="password" required="" name="agency_password" class="form-control" placeholder="Password" value="{{old('agency_password')}}">
