      ...
      <div class="col-md-12">
         <div class="card">
            ...
            <div class="col-lg-12">
               ...
               @endif
               <form action="{{route('store.customer_reward.save')}}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="row">
                    ...
                    <div class="form-group">
                           ...
                           Reset</button>
                           <a class="btn btn-danger" href="{{ route('store.customer_reward.list') }}">Cancel</a>
                           </center>
                        </div>
               </form>
