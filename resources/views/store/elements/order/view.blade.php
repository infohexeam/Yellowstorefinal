                     ...
                     <div class="col-md-12">
                        <div class="card">
                           <div style="    justify-content: space-between;" class="card-header">
                              ...
                              <a onclick="GoBackWithRefresh();return false;"
                                 class="btn btn-cyan float-right text-white ">Back</a>
                                    ...
                                    <tbody class="col-lg-12 col-xl-6 p-0">
                                       ...
                                       <tr>
                                          ...
                                          <td>{{ @$order->customer['customer_first_name']}} {{
                                             @$order->customer['customer_last_name']}} </td>
                                       </tr>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <h3> <i class="fa fa-inr"></i> {{ @$order->product_total_amount }} </h3>
                                          </td>
                                       </tr>

                                       <tr>
                                          <td><strong>Delivery Charge: </strong> </td>
                                          <td> @if(isset($order->delivery_charge)){{ @$order->delivery_charge}} @else
                                             0.00 @endif</td>
                                       </tr>

                                       <tr>
                                          <td><strong>Packing Charge: </strong> </td>
                                          <td> @if(isset($order->packing_charge)){{ @$order->packing_charge}} @else 0.00
                                             @endif</td>
                                       </tr>
                                       <tr>
                                          <td>
                                             <strong>Redeemed Admin Amount By wallet: </strong>
                                          </td>
                                          <td> @if(isset($order->amount_reduced_by_rp))
                                       ...
                                       <tr>
                                          <td>
                                             <strong>Redeemed Store Amount By Wallet: </strong>
                                          </td>
                                          <td> @if(isset($order->amount_reduced_by_rp_store))
                                             {{ @$order->amount_reduced_by_rp_store}} ({{
                                             @$order->reward_points_used_store}} points )
                                             @else
                                             0.00
                                             @endif</td>
                                       </tr>
                                       <tr>
                                          <td>
                                             <strong>Redeemed Amount By Coupon: </strong>
                                          </td>
                                          <td> @if(isset($order->amount_reduced_by_coupon)) {{
                                             @$order->amount_reduced_by_coupon }} @else 0.00 @endif</td>
                                       </tr>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             @php
                                             $deliveryTimeSlot =
                                             Trn_StoreDeliveryTimeSlot::withTrashed()->find($order->time_slot);
                                             @endphp
                                             Time Slot Delivery ({{ @$deliveryTimeSlot->time_start . "-" .
                                             @$deliveryTimeSlot->time_end }})
                                             @else
                                             Immediate Delivery
                                             @endif
                                             @else
                                             ...
                                             Immediate Delivery
                                             @if($order->immediate_store_text)({{@$order->immediate_store_text}}) @endif
                                             @endif
                                             ...
                                             Future Delivery<br>Expected Delivery
                                             Date:{{date('d-M-Y',strtotime(@$order->future_delivery_date))}}
                                             @php
                                             $deliveryTimeSlot =
                                             Trn_StoreDeliveryTimeSlot::withTrashed()->find($order->time_slot);
                                             @endphp
                                             <br>
                                             (Slot: {{ @$deliveryTimeSlot->time_start . "-" .
                                             @$deliveryTimeSlot->time_end }})
                                             @endif
                                       ...
                                       <tr>
                                          ...
                                          <td> {{ @$order->storeadmin['admin_name'] }} </td>
                                       </tr>
                                       @endif
                                       ...
                                       <tr>
                                          ...
                                          <td>{{ @$order->status->status}} @if(@$order->status->status_id == 9) ( {{
                                             \Carbon\Carbon::parse(@$order->delivery_date)->format('d-m-Y')}} {{
                                             @$order->delivery_time }} ) @endif </td>
                                       </tr>
                                       @else
                                       <tr>
                                          <td><strong>Order Status: </strong> </td>
                                          <td>{{ @$order->status->status}} @if(@$order->status->status_id == 9) @endif
                                          </td>
                                       </tr>
                                       @endif
                                       ...
                                       @php
                                       $oredrAddr =
                                       \DB::table('trn_customer_addresses')->where('customer_address_id',$order->delivery_address)->first();
                                       @endphp
                                       <tr>
                           ...
                           <div class="card-body">
                              <div class="table-responsive">
                                 <table class="table row table-borderless">
                                    <tbody class="col-lg-12 col-xl-6 p-0">
                                       <tr>
                                          <td><strong>Delivery Boy Name :</strong>
                                             {{@$order->delivery_boy['delivery_boy_name']}}</td>
                                       </tr>

                                       <tr>
                                          <td><strong>Delivery Phone :</strong>
                                             {{@$order->delivery_boy['delivery_boy_mobile']}}</td>
                                       </tr>
                                       @if($order->status_id!=5)
                                       <tr>
                                          <td><strong>Delivery Date :</strong> {{
                                             \Carbon\Carbon::parse($order->delivery_date)->format('M d, Y')}}</td>
                                       </tr>
                                       @endif
                                    </tbody>
                                 </table>
                        ...
                        <div class="card">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             ...
                                             <img
                                                src="{{asset('/assets/uploads/products/base_product/base_image/'.@$order_item->product_varient->product_varient_base_image)}}"
                                                width="50">
                                             <br>
                                             {{ @$order_item->product_varient->variant_name }}
                                             @else
                                             <img
                                                src="{{asset('/assets/uploads/products/base_product/base_image/'.@$order_item->product_image)}}"
                                                width="50">
                                             <br>
                                             ...
                                             {{date('g:i A',strtotime($order_item->time_start))}}-{{date('g:i
                                             A',strtotime($order_item->time_end))}}
                                             @endif
                                             @endif
                                             @endif

                                             {{-- {{@$order_item->product->product_name}}
                                             @if (isset($order_item->product_varient_id) &&
                                             $order_item->product_varient_id != 0 )
                                             @if (@$order_item->product->product_name !=
                                             @$order_item->product_varient->variant_name )
                                             @if(strlen($order_item->product->product_name.$order_item->product_varient->variant_name)
                                             < 15) - {{ @$order_item->product_varient->variant_name }}
                                                @else
                                          ...
                                          <td>
                                             @php
                                             //$discountAmt = $order_item->quantity *
                                          ...
                                          $tTax = $order_item->quantity * (@$order_item->unit_price *
                                          @$tax_info->tax_value / (100 + @$tax_info->tax_value));
                                          $orgCost = $order_item->quantity * (@$order_item->unit_price * 100 / (100 +
                                          @$tax_info->tax_value));
                                          $Tot = $tTax + $orgCost;
                                          @endphp
                                          ...
                                          $splitdata =
                                          \DB::table('trn__tax_split_ups')->where('tax_id',@$tax_info->tax_id)->get();
                                          // dd($splitdata);
                                          @endphp

                                          <td>@if(isset($tax_info->tax_value)){{@$tax_info->tax_value}} @else No tax
                                             @endif</td>
                                          <td>
                                             <table style="line-height: 1px; font-size: 12px;">
                                                ...
                                                <tr>
                                                   <td
                                                      style="line-height: normal;border: none;padding: 0;font-size: medium;">
                                                      @php
                           ...
                           <div class="card">
                              <div class="card-body">
                                 ...
                                 <h5>Payment Split Information @if(@$payment->paymentRole == 1) for Store @else for
                                    Admin @endif</h5>
                                 <table class="table table-bordered text-nowrap w-100">
                                    <tr>
                                       <td>
                                 ...
                                 <div class="card-body">
                                    ...
                                    <table class="table row table-borderless">
                                       <tbody class="col-lg-12 col-xl-6 p-0">
                                          @php
                                          $serviceVarDetail =
                                          \DB::table('mst_store_product_varients')->where('product_varient_id',@$order->product_varient_id)->first();
                                          $serviceDetail =
                                          \DB::table('mst_store_products')->where('product_id',@$serviceVarDetail->product_id)->first();
                                          $addCus =
                                          \DB::table('trn_customer_addresses')->where('customer_address_id',@$order->delivery_address)->first();
