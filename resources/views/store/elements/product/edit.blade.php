                  ...
                  <div id="service_type_id" class="col-md-12">
                   ...
                   <div class="form-group">
                    <div class="BaseFeatureArea">
                     ...
                     <input type="file" accept="image/png, image/jpeg, image/jpg" class="form-control imgValidation" name="product_image[]" multiple=""  >
                        <br>
                     </div>
                     </div>
                 </div>
               ...
               <div  id="attRow" class="section">
                 ...
                 <div style="border: 1px solid #0008ff42;"  class="mt-2 row">
                   ...
                   <div class="col-md-6">
                     <div class="form-group">
                         <label class="form-label">MRP </label>
                         <input step="0.01" required type="number" class="form-control proVariant"  oninput="regularPriceChangeVar(0)"
                   ...
                   <div class="col-md-6">
                       <div class="form-group">
                           ...
                           name="var_sale_price[]" required  id="var_sale_price0" value="" placeholder="Sale Price">
