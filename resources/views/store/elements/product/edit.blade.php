                  ...
                  <div id="service_type_id" class="col-md-12">
                   ...
                   <div class="form-group">
                    <div class="BaseFeatureArea">
                     ...
                     <input type="file" accept="image/png, image/jpeg, image/jpg" class="form-control" name="product_image[]" multiple=""  >
                        <br>
                     </div>
                     </div>
                 </div>
                 ...
                 <div style="border: 1px solid #0008ff42;"  class="mt-2 row">
                   ...
                   <div class="col-md-12">
                     <div class="form-group">
                         ...
                         <input type="file" multiple accept="image/png, image/jpeg, image/jpg" class="form-control proVariant" name="var_images[0][]" >
                     </div>
                 </div>
              </div>
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-12">
                                    <div class="form-group">
                                       ...
                                       <input type="file" accept="image/png, image/jpeg, image/jpg" multiple class="form-control proVariant" name="var_image[]" >
                                    </div>
                              </div>
...
$(document).ready(function() {
  ...
  $(add_button).click(function(e){ //on add input button click
    ...
    //max input box allowed
      x++; //text box increment
      $(wrapper).append('<div>  <input type="file" class="form-control" name="product_image[]"  accept="image/png, image/jpeg, image/jpg" multiple="" value="{{old('product_image')}}" placeholder="Base Product Feature Image" /> <a href="#" class="remove_field btn btn-primary">Remove</a></div>'); //add input box
