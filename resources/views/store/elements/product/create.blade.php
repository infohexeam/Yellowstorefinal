                    ...
                    <div  id="attRow" class="section">
                      ...
                      <div style="border: 1px solid #0008ff42;"  class="mt-2 row">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="form-label">Upload Images*</label>
                            <input type="file" required id="fileInput" accept="image/png, image/jpeg, image/jpg"  multiple class="form-control proVariant imgValidation" name="var_images[0][]" >
                          </div>
                      </div>
                   </div>
