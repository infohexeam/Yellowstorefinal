...
<div class="container">
    <div class="row justify-content-center">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                             ...
                                             $order_fetch=DB::table('trn_store_orders')->where('order_id',$d->order_id)->first();
        ...
        //$d->amount_before_applying_rp=strval(number_format($item_price+$w->packing_charge+$w->delivery_charge,2));number_format($item_price-$d->packing_charge-$d->delivery_charge-$d->amount_reduced_by_coupon??0,2) }}
                                            ...
                                            @endphp
                                            <td>{{ number_format($item_price+$order_fetch->delivery_charge+$order_fetch->packing_charge-$d->amount_reduced_by_coupon,2) }}</td>
