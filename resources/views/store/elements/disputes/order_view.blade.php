                              ...
                              <div style="background-color:#f1f1f9;" class="table-responsive">
                               <table class="table table-striped table-bordered text-nowrap w-100">
                                 ...
                                 <tbody>
                                    ...
                                    @php
                                       if ($datazz = \DB::table("mst_disputes")->where('store_id', $order_item->store_id)->where('order_id', $order_item->order_id)->first()) {
                                            ...
                                            if (in_array($order_item->product_varient_id, $colorsArray2)) {
                                                $dispute_status = 1;
                                            } else {
                                                $dispute_status = 0;
                                            }
