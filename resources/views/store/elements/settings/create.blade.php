              ...
              <div class="row">
                ...
                <div class="col-md-6">
                 ...
                 Collect From Store
                   ...
                   <div class="col-md-6" id="moa" style="display:none;"> 
                      <div class="form-group">
                     ...
                     <table id="first" class="table">
                      ...
                      @endphp
                          ...
                          @foreach ($store_settings as $data)
                              ...
                              <td>
                                <input type="number" min="0" step="1" oninput="validity.valid||(value='');" required value="{{ $data->minimum_order_amount }}" id="minimum_order_amount0" class="form-control"  name="minimum_order_amount[]">
                              </td>
                              <td>
                                <input type="number" min="0" max="100" step="1" oninput="validity.valid||(value='');" required value="{{ $data->reduction_percentage }}"  id="reduction_percentage0" class="form-control"  name="reduction_percentage[]">
                              </td>
                              @if($loop->last)
                               <td>
                        ...
                        @else
                             <tr class="trClass" id="trSec0" >
                              ...
                              <td>
                                <input type="number" min="0" max="100" step="1" oninput="validity.valid||(value='');" required value="0"  id="reduction_percentage0" class="form-control"  name="reduction_percentage[]">
                              </td>
                             <td>
