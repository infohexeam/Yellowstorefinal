            ...
            <div class="">
               ...
               <div class="container-login100">
                  <div class="wrap-login100 p-6" style="width:400px;">
                     <form method="POST" action="{{ route('forgot_password_otp_verify.store',$stores->store_id) }} ">
                        @csrf
                    ...
                    @endif
                        ...
                        <div class="wrap-input100 validate-input">
                         ...
                         {{-- <div class="container-login100-form-btn">
                          <a onclick="return confirm('Do you want to Resend OTP?');" href="{{url('store/forgot/password/resend_otp/'.$stores->store_id)}}" >Resend OTP?</a>
