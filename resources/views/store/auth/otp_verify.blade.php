                  ...
                  <div class="wrap-login100 p-6" style="width:400px;">
                     <form method="POST" action="{{ route('register.store') }} ">
                        ...
                        <div class="wrap-input100 validate-input">
                            <input type="hidden" name="customer_id" value="{{$stores->store_id}}" >
                           <input class="input100" id="store_otp" type="store_otp" name="store_otp" placeholder="Store Name" value="{{ old('store_otp') }}" required autocomplete="store_otp" >
                           @error('store_otp')
